<?php
/*
	Function untuk mengetahui linked list dari search , insert first, insert last, insert after, insert before, delete first, delete last, delete after, delete before

	Inputan :
		- Data yang akan di linked list
		- Pencarian note yang akan di linked list
	Output :
		- Penyimpanan data note dari awal, akhir, atau tenggah-tenggah
		- Menghapus data note dari awal, akhiur, atau tenggah-tenggah
		- Reverse data note (random)
		- Sort data note 
		- Kevalid an data note
		- Posisi data note
*/ 
class Node {
	public $data = NULL;
